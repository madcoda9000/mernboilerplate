...
meta.content +=
  "style-src data: 'unsafe-inline' 'unsafe-hashes' 'self' " + WEB_URL + " " + BASE_URL + "; "
meta.content +=
  "style-src-elem data: 'unsafe-inline' 'unsafe-hashes' 'self' " + WEB_URL + " " + BASE_URL + "; "
meta.content +=
  "style-src-attr data: 'unsafe-inline' 'unsafe-hashes' 'self' " + WEB_URL + " " + BASE_URL + "; "

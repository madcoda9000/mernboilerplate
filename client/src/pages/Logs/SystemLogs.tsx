...
/**
 * Function component for displaying System Logs.
 *
 * @return {JSX.Element} The rendered JSX for System Logs.
 */
const SystemLogs = () => {
        ...
        <div className="hidden space-y-6 pb-16 md:block">
          ...
          <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-10 lg:space-y-0">
            ...
            <div className="flex-1 ">
              <h3 className="mb-4 text-lg font-medium ml-1">System Logs</h3>
              {isLoading ? (
                <>

...
import { Box, Button, Center, CircularProgress, Flex, FormControl, FormLabel, HStack, Heading, Icon, Input, Spacer, VStack, useMediaQuery, useToast } from "@chakra-ui/react";
                            ...
                            (
                                <>
                                    <HStack>
                                        ...
                                        <Heading fontSize={'2xl'} display={'inline'}  >Create new Role...</Heading>
                                    </HStack>
                                    ...
                                    <Flex>
                                        <Box w={'60%'} paddingRight={'30px'} mt={'30px'}>
                                            ...
                                            <HStack mt={'30px'}>
                                                ...
                                                <Button type="button" colorScheme={'blue'} variant={'solid'} isLoading={btnPwIsloading} disabled={btnPwIsloading} loadingText='Saving...' onClick={() => SaveRole()}>
                                                    Save role...
                                                </Button>
                                            </HStack>
                                        </Box>

                        ...
                        {isLargerThan500 ?
                            (
                                <>
                                    ...
                                    <HStack>
                                        <Flex width={'100%'}>
                                            <HStack>
                                                ...
                                                <Heading fontSize={'2xl'} display={'inline'}  >Manage Roles...</Heading>
                                            </HStack>
                                            <Spacer />
                                            <HStack>
                                                <InputGroup borderRadius={5} size="sm">
                                                    ...
                                                    >
                                                        ...
                                                        <Button size="sm" borderLeftRadius={0} borderLeft={'1px solid var(--chakra-colors-gray-300)'} type="button" colorScheme={'whatsapp'} variant={'solid'} onClick={() => navigate('/Admin/RoleNew')}  >
                                                            create new Role
                                                        </Button>
                                                    </InputRightAddon>
                                                </InputGroup>
                                                            ...
                                                            <HStack>
                                                                <Tooltip label='Delete role...' fontSize='sm'>
                                                                    <ComponentWithForwardRef>
                                                                        <IconButton onClick={() => openDialog(role._id)} isDisabled={role.roleName === 'users' || role.roleName === 'admins'} size={'xs'} aria-label='Delete user...' icon={<MdDelete />} backgroundColor={'red.500'} color={'white'} isRound={true} variant='solid' colorScheme="red" />
                                                                    </ComponentWithForwardRef>
                                                                </Tooltip>
                                                            </HStack>
                                                        </Td>
                                    ...
                                    <Box width={'100%'}>
                                        <Paginator pageSize={RolesData.limit} totalPages={RolesData.pages} currentPage={RolesData.page} nextPageMethod={NextPage} prevPageMethod={PrevPage} totalItems={RolesData.total} pageSizeMethod={ChangePageSize} />
                                    </Box>

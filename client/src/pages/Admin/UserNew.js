...
import { Alert, AlertIcon, Box, Button, Center, Checkbox, CircularProgress, Flex, FormControl, FormLabel, HStack, Heading, Icon, Input, InputGroup, InputLeftElement, InputRightElement, Spacer, Stack, VStack, useMediaQuery, useToast } from "@chakra-ui/react";
                            ...
                            (
                                <>
                                    <HStack>
                                        ...
                                        <Heading fontSize={'2xl'} display={'inline'}  >Create new User...</Heading>
                                    </HStack>
                                    ...
                                    <Flex>
                                        ...
                                        <Box w={'30%'} paddingLeft={'30px'}>
                                            ...
                                            {allRoles ? allRoles.docs.map((role, i) => {
                                                return <Stack direction='column' mt={'20px'} key={i}>
                                                    <label className="container">{role.roleName}
                                                        <input onChange={(e) => valChkBx(e.target.id)} type="checkbox" name={role.roleName} id={role.roleName} label={role.roleName} data-rname={role.roleName} data-grp="roleName" />

                  ...
                  <Tbody>
                    {LogData.docs.map((log, i) => (
                      <Tr key={i}>
                        ...
                        <Td maxWidth={isLargerThan1280 ? "700px" : "100%"} style={{ overflow: "hidden" }}>
                          {log.message}
                        </Td>
                        <Td>
                          <MdInfo cursor={"pointer"} onClick={() => openDialog(log)} color="var(--chakra-colors-blue-500)" size={20} title="view details..." />
                        </Td>
                      </Tr>
                    ))}
                  </Tbody>

const Privacy = () => {
  return (
    <div className="p-8 overflow-y-auto h-[100vh] max-h-[100vh]">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">Last updated: January 24, 2024</p>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GreatApp.
          </p>
        </li>
        <li>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <li>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            <strong>Website</strong> refers to GreatApp, accessible from{" "}
            <a href="https://greatapp.com" rel="external nofollow noopener" target="_blank">
              https://greatapp.com
            </a>
          </p>
        </li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          <p className="leading-7 [&:not(:first-child)]:mt-6">Email address</p>
        </li>
        <li>
          <p className="leading-7 [&:not(:first-child)]:mt-6">First name and last name</p>
        </li>
        <li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">Type: Session Cookies</p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">Administered by: Us</p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <li>
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">Type: Persistent Cookies</p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">Administered by: Us</p>
          <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Business Transactions</h4>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>By email: greatapp@greatapp.com</li>
      </ul>
    </div>
  )
}

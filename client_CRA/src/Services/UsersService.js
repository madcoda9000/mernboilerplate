...
class UsersService {
   ...
   */
  lockUser(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/lockUser", payload);
  }
   ...
   */
  unlockUser(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/unlockUser", payload);
  }
   ...
   */
  disableMfa(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/disableMfa", payload);
  }
   ...
   */
  enableLdap(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/enableLdap", payload);
  }
   ...
   */
  disableLdap(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/disableLdap", payload);
  }
  ...
  enableMfaEnforce(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/enforceMfa", payload);
  }
  ...
  disableMfaEnforce(payload) {
    return jwtInterceptor.patch(apiurl + "/v1/users/unenforceMfa", payload);
  }
}

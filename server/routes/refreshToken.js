...
router.post("/createNewAccessToken", async (req, res) => {
	...
	verifyRefreshToken(req.body.refreshToken)
		.then(({ tokenDetails }) => {
			const payload = { _id: tokenDetails._id, firstName: tokenDetails.firstName, lastName: tokenDetails.lastName, userName:tokenDetails.userName, email: tokenDetails.email, roles: tokenDetails.roles, mfaEnabled: tokenDetails.mfaEnabled, mfaEnforced: tokenDetails.mfaEnforced};
